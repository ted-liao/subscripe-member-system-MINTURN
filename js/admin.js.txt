...
function updateUserSection() {
    ...
    if (currentUser && currentUser.isAdmin) {
        ...
        <a href="index.html" class="btn btn-small" data-lang-key="back_to_home">${trans.back_to_home}</a>
        <button class="btn btn-danger btn-small" onclick="logout()" data-lang-key="logout">${trans.logout}</button>
        `;
    } else {
        userSection.innerHTML = `
        <a href="index.html" class="btn btn-small" style="background: #f0f0f0; color: #333;" data-lang-key="back_to_home">${trans.back_to_home}</a>
